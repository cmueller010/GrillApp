...
public class GrillApp implements EntryPoint {
	...
	private final IEmailServiceAsync emailService = GWT.create(IEmailService.class);
	...
	public void onModuleLoad() {
		 ...
		 * 
		 * @Override public String getValue(Person p) { return p.getName(); }
		 * 
		 * }; // Add the column to the table and set a column title
		 * personTable.addColumn(nameColumn, "Name");
		 * 
		 * // Adresse TextColumn<Person> adresseColumn = new
		 * TextColumn<Person>() {
		 * 
		 * @Override public String getValue(Person p) { return p.getAdresse(); }
		 * 
		 * }; personTable.addColumn(adresseColumn, "Adresse");
		 * 
		 * // anwesend TextColumn<Person> anwesendColumn = new
		 * TextColumn<Person>() {
		 * 
		 * @Override public String getValue(Person p) { return
		 * toJaNein(p.getAnwesend()); } }; personTable.addColumn(anwesendColumn,
		 * "anwesend");
		 * 
		 * // Admin TextColumn<Person> adminColumn = new TextColumn<Person>() {
		 * 
		 * @Override public String getValue(Person p) { return
		 * toJaNein(p.getAdmin()); }
		 * 
		 ...
		 * 
		 * // Add the table to the RootPanel // Use RootPanel.get() to get the
		 * entire body element // 'personTableContainer' is defined in
		 * GrillApp.html
		 * 
		 ...
		 * 
		 * @Override public void onFailure(Throwable caught) { // Notify the
		 * user that an error occurred Label error = new Label(SERVER_ERROR +
		 * caught.getLocalizedMessage()); // 'errorLabelContainer' is specified
		 * in GrillApp.html
		 * RootPanel.get("personErrorLabelContainer").add(error); }
		 * 
		 * @Override public void onSuccess(List<Person> result) { // Add the
		 * persons to the table personTable.setRowData(result); } });
		 * 
		 * final CellTable<Email> emailTable = new CellTable<Email>();
		 * 
		 * // Betreff TextColumn<Email> betreffColumn = new TextColumn<Email>()
		 * {
		 * 
		 * @Override public String getValue(Email e) { return e.getBetreff(); }
		 * 
		 * }; emailTable.addColumn(betreffColumn, "Betreff");
		 * 
		 * // Text TextColumn<Email> textColumn = new TextColumn<Email>() {
		 * 
		 * @Override public String getValue(Email e) { return e.getText(); }
		 * 
		 ...
		 * 
		 * // TODO Anlass Table final CellTable<Anlass> anlassTable = new
		 * CellTable<Anlass>();
		 * 
		 ...
		 * 
		 * @Override public String getValue(Anlass a) { return a.getTitel(); }
		 * };
		 * 
		 ...
		 * 
		 * @Override public String getValue(Anlass a) { return a.getKommentar();
		 * } };
		 * 
		 ...
		 * 
		 * @Override public String getValue(Anlass a) {
		 * 
		 * DateTimeFormat zeitFormat = DateTimeFormat.getFormat("dd MMM yyyy");
		 ...
		 * 
		 * @Override public String getValue(Anlass a) { return
		 * a.getTyp().toString(); } };
		 * 
		 ...
		 * 
		 * @Override public void onSuccess(List<Anlass> result) {
		 * anlassTable.setRowData(result); } });
		 * 
		 * }
		 * 
		 * private void addButtonColumn(final CellTable<Anlass> anlassTable,
		 * String columnHeader, final String buttonLabel) { ButtonColumn<Anlass>
		 * bearbeitenColumn = new ButtonColumn<Anlass>() {
		 * 
		 * @Override public String getValue(Anlass anlass) { // only set
		 * sensitive if user is the organizer return buttonLabel; } };
		 * anlassTable.addColumn(bearbeitenColumn, columnHeader);
		 * 
		 * bearbeitenColumn.setFieldUpdater(new FieldUpdater<Anlass, String>() {
		 * 
		 * @Override public void update(int index, Anlass object, String value)
		 * { Window.alert("You clicked " + object.getTitel()); } }); }
		 * 
		 * static String toJaNein(boolean value) { return value ? "Ja" : "Nein";
		 * 
		 * }
		 */
